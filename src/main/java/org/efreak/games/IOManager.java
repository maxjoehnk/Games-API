...
import org.efreak.games.util.Translator;
...
public class IOManager {
	...
	public static String prefix = ChatColor.DARK_RED + "[Games] " + ChatColor.WHITE;
	...
	public void init() {
		...
		conversationFactory = new ConversationFactory(Games.getInstance());
	...
	public void sendTranslation(CommandSender sender, String key, boolean showPrefix) {
